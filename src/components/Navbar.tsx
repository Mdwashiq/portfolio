    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between w-full">
          ...
          {/* Logo with M Tricolor vertical bar */}
          <button 
          ...
          {/* Desktop Nav Links (Sentence-case) */}
          <div className="hidden lg:flex items-center space-x-8">
            {navLinks.map((link) => (
              <button
                key={link.id}
                onClick={() => scrollToSection(link.id)}
                className={`relative py-1 text-sm font-normal tracking-[0.5px] transition-colors duration-300 cursor-none ${
          ...
          {/* CTA: Rectangular white outline button */}
