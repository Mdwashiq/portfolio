...
function SkillCard({ skill, index }: { skill: any; index: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Progress Bar: M Tricolor gradient */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skillCategories.map((category, catIdx) => (
            <motion.div
              ...
              className="p-6 bg-surface-soft border border-hairline rounded-none flex flex-col space-y-6 relative"
            >
              {/* Category Header */}
