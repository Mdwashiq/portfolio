    ...
    <section id="about" className="py-24 relative overflow-hidden bg-black border-t border-hairline">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12" ref={containerRef}>
          ...
          {/* Left Column: Stark Grayscale Photo & Biography */}
          <div className="lg:col-span-6 flex flex-col space-y-10">
            ...
            >
              ...
              {/* Float code tag */}
              <div className="absolute bottom-6 left-6 z-20 bg-black/90 border border-hairline py-1.5 px-3 rounded-none text-[10px] font-mono text-m-red uppercase tracking-widest">
            ...
            >
              ...
              {/* Objective inside Surface Soft box */}
              <p className="bg-surface-soft border border-hairline p-5 rounded-none font-light italic">
                {aboutInfo.objective}
              </p>
